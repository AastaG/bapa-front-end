...
! function(t, e) {
    ...
    return function(t) {
        ...
        var r = i(n(1)),
            o = i(n(15)),
            s = function(t) {
                t.component("carousel3d", r.default), t.component("slide", o.default)
            };
        e.default = {
            install: s
        }, e.Carousel3d = r.default, e.Slide = o.default
    }, function(t, e, n) {
        n(2);
        ...
        function i(t) {
            for (var e = 0; e < t.length; e++) {
                ...
                if (i) {
                    i.refs++;
                    for (o = 0; o < i.parts.length; o++) i.parts[o](n.parts[o]);
                    for (; o < n.parts.length; o++) i.parts.push(s(n.parts[o]));
                    i.parts.length > n.parts.length && (i.parts.length = n.parts.length)
                } else {
                    for (var r = [], o = 0; o < n.parts.length; o++) r.push(s(n.parts[o]));
                    l[n.id] = {
                        id: n.id,
                        refs: 1,
                        parts: r
        ...
        function r(t, e) {
            for (var n = [], i = {}, r = 0; r < e.length; r++) {
                ...
                i[s] ? (a.id = t + ":" + i[s].parts.length, i[s].parts.push(a)) : (a.id = t + ":0", n.push(i[s] = {
                    id: s,
                    parts: [a]
                }))
            }
        ...
        function s(t) {
            ...
            if (x) {
                var s = f++;
                i = h || (h = o()), e = a.bind(null, i, s, !1), n = a.bind(null, i, s, !0)
        ...
        e.default = {
            ...
            methods: {
                ...
                goSlide: function(t) {
                	console.log(t);
                	var id = jQuery(jQuery(this.$root.$el)[0]).prop('id').split("-")[2];
                	console.log(id);
                	var currSlideD = $("#slide-d-"+ id +"-"+ t);
                	var currSlideDParent = currSlideD.closest('.evnt-sldr-det');
                	var allCurrSlideD = currSlideDParent.find('.slide-d');
                	allCurrSlideD.removeClass("show");
                	currSlideD.addClass("show");
                    // $(".slide-d").removeClass("show"), $("#slide-d-" + t).addClass("show");
                    var e = this;
                    this.currentIndex = t < 0 || t > this.total - 1 ? 0 : t, this.lock = !0, this.isLastSlide && (this.onLastSlide !== a && console.warn("onLastSlide deprecated, please use @lastSlide"), this.onLastSlide(this.currentIndex), this.$emit("lastSlide", this.currentIndex)), this.$emit("slideChange", this.currentIndex), setTimeout(function() {
                ...
                animationEnd: function() {
                    this.lock = !1, this.onSlideChange !== a && console.log("onSlideChange deprecated, please use @afterSlideChanged"), this.onSlideChange(this.currentIndex), this.$emit("afterSlideChanged", this.currentIndex)
                },
        ...
        e.default = {
            ...
            methods: {
                ...
                goTo: function() {
                    !0 === this.parent.clickable && this.parent.goFar(this.index)
                }
            }
        }
    }, function(t, e, n) {
        ...
        var i = n(23),
            ...
            u = function(t, e, n) {
                var c, l, d, h = t & u.F,
                    ...
                    b = f ? i : p ? i[e] : (i[e] || {})[a];
                f && (n = e);
                for (c in n)(l = !h && b && void 0 !== b[c]) && c in g || (d = l ? b[c] : n[c], g[c] = f && "function" != typeof b[c] ? n[c] : x && l ? o(d, i) : m && b[c] == d ? function(t) {
                    ...
                    return e[a] = t[a], e
                }(d) : v && "function" == typeof d ? o(Function.call, d) : d, v && ((g.virtual || (g.virtual = {}))[c] = d, t & u.R && y && !y[c] && s(y, c, d)))
            };
        ...
        t.exports = !u || n(33)(function() {
            ...
            for (var n = s(t), u = arguments.length, c = 1, l = r.f, d = o.f; u > c;)
                for (var h, f = a(arguments[c++]), p = l ? i(f).concat(l(f)) : i(f), v = p.length, x = 0; v > x;) d.call(f, h = p[x++]) && (n[h] = f[h]);
            return n
        } : u
    }, function(t, e, n) {
        var i = n(39),
